...
/** @type {string} */
const CACHE_VERSION = '1764546216|14555086985';
/** @type {string} */
const CACHE_PREFIX = 'JJk Fighting gam-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'jjkfighting.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["jjkfighting.html","jjkfighting.js","jjkfighting.offline.html","jjkfighting.icon.png","jjkfighting.apple-touch-icon.png","jjkfighting.audio.worklet.js","jjkfighting.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["jjkfighting.wasm","jjkfighting.pck","jjkfighting.side.wasm"];
